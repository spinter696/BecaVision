...
This script compute the different regions of a image with
...
def computingRegions(img,n,m):
    ...
    # plt.subplot(2,4,1),plt.imshow(regiones[0],cmap='gray',interpolation='bicubic')
    # plt.subplot(2,4,5),plt.imshow(regiones[1],cmap='gray',interpolation='bicubic')
    # plt.subplot(2,4,2),plt.imshow(regiones[2],cmap='gray',interpolation='bicubic')
    # plt.subplot(2,4,6),plt.imshow(regiones[3],cmap='gray',interpolation='bicubic')
    # plt.subplot(2,4,3),plt.imshow(regiones[4],cmap='gray',interpolation='bicubic')
    # plt.subplot(2,4,7),plt.imshow(regiones[5],cmap='gray',interpolation='bicubic')
    # plt.subplot(2,4,4),plt.imshow(regiones[6],cmap='gray',interpolation='bicubic')
    # plt.subplot(2,4,8),plt.imshow(regiones[7],cmap='gray',interpolation='bicubic')
    # plt.show()
